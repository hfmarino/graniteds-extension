...
package org.granite.tide.spring {
	...
	public class Spring extends Tide {
		...
		public override function login(ctx:BaseContext, component:IComponent, username:String, password:String, responder:ITideResponder = null):AsyncToken {
            ...
            token.addResponder(new ComponentResponder(ctx, springLoginSuccessHandler, springLoginFaultHandler, component.meta_name, null, null, responder, username));
            
            return token;
		}
		
        public function springLoginSuccessHandler(sourceContext:BaseContext, sourceModulePrefix:String, data:Object, username:String, componentName:String = null, op:String = null, tideResponder:ITideResponder = null):void {
        ...
        public function springLoginFaultHandler(sourceContext:BaseContext, sourceModulePrefix:String, data:Object, username:String, componentName:String = null, op:String = null, tideResponder:ITideResponder = null):void {
        	getSpringContext().identity.username = null;
        	getSpringContext().identity.loggedIn = false;
