...
package org.granite.tide.cdi {
	...
	public class Cdi extends Tide {
		...
		public override function login(ctx:BaseContext, component:IComponent, username:String, password:String, responder:ITideResponder = null):AsyncToken {
            ...
            token.addResponder(new ComponentResponder(ctx, cdiLoginSuccessHandler, cdiLoginFaultHandler, component.meta_name, null, null, responder, username));
            
            return token;
		}
		
        public function cdiLoginSuccessHandler(sourceContext:BaseContext, sourceModulePrefix:String, data:Object, username:String, componentName:String = null, op:String = null, tideResponder:ITideResponder = null):void {
        ...
        public function cdiLoginFaultHandler(sourceContext:BaseContext, sourceModulePrefix:String, data:Object, username:String, componentName:String = null, op:String = null, tideResponder:ITideResponder = null):void {
        	getCdiContext()['org.granite.tide.cdi.identity'].username = null;
        	getCdiContext()['org.granite.tide.cdi.identity'].loggedIn = false;
