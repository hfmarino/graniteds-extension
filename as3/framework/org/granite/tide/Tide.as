...
package org.granite.tide { 
	...
	public class Tide extends EventDispatcher {
		...
		public static const TYPE_STRING:Type = Type.forClass(String);
		public static const TYPE_BASECONTEXT:Type = Type.forClass(BaseContext);
		public static const TYPE_SUBCONTEXT:Type = Type.forClass(Subcontext);
		public static const TYPE_ICOMPONENT:Type = Type.forClass(IComponent);
		public static const TYPE_IENTITY:Type = Type.forClass(IEntity);
		public static const TYPE_ILIST:Type = Type.forClass(IList);
		public static const TYPE_IUICOMPONENT:Type = Type.forClass(IUIComponent);
		...
		private function internalAdd(component:Object):void {
			...
			if (!_componentStore.isFxClass(className)) {
				var info:ComponentInfo = ComponentInfo.forType(Type.forInstance(component));
				if (info.name != null) {
		...
		public function addComponents(types:Array):void {
		    for each (var type:Class in types) {
				...
				var info:ComponentInfo = ComponentInfo.forType(t);
				var componentName:String = info.name;
		    	if (!componentName) {
		    	...
		    	var name:String = info.module ? info.module + "." + componentName : componentName;
		...
		public function invokeComponent(ctx:BaseContext, component:IComponent, op:String, args:Array, responder:ITideResponder, 
		    ...
		    var componentResponder:ComponentResponder = new ComponentResponder(ctx, rh, fh, component.meta_name, op, operation, responder)
		    ...
		    if (ro != null) {
				...
				var alias:String = Type.forInstance(component).alias;
